...
// in series/test/presentation/bloc/series/series_detail_bloc_test.dart.
...
import 'package:series/domain/entities/tv/tv.dart' as _i8;
import 'package:series/domain/entities/tv/tv_detail.dart' as _i7;
import 'package:series/domain/repositories/tv_repository.dart' as _i2;
import 'package:series/series.dart' as _i4;
import 'package:watchlist/domain/usecases/tv/get_tv_watchlist_status.dart'
    as _i9;
import 'package:watchlist/domain/usecases/tv/tv_remove_watchlist.dart' as _i11;
import 'package:watchlist/domain/usecases/tv/tv_save_watchlist.dart' as _i10;
...
class MockGetTvRecommendations extends _i1.Mock
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTvRepository_0()) as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i8.TV>>> execute(dynamic id) =>
      (super.noSuchMethod(Invocation.method(#execute, [id]),
              returnValue: Future<_i3.Either<_i6.Failure, List<_i8.TV>>>.value(
                  _FakeEither_1<_i6.Failure, List<_i8.TV>>()))
          as _i5.Future<_i3.Either<_i6.Failure, List<_i8.TV>>>);
}
