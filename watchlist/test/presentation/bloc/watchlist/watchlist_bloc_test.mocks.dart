...
import 'package:series/series.dart' as _i8;
import 'package:watchlist/domain/usecases/movie/get_watchlist_movies.dart'
    as _i3;
import 'package:watchlist/domain/usecases/tv/get_tv_watchlist.dart' as _i7;
...
/// A class which mocks [GetTvWatchlistMovies].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetTvWatchlistMovies extends _i1.Mock
    implements _i7.GetTvWatchlistMovies {
  MockGetTvWatchlistMovies() {
    _i1.throwOnMissingStub(this);
  }
